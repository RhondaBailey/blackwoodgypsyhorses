...
export function Home() {
    ...
    return (
        <>
        <div className="homeContentMowMow">
            ...
            <div className="sliderContainerMow">
                {slider}
            </div>
            <br /><br /><br /><br />
        </div>
...
export function About() {
    return (
        <div><h2>Our Story</h2>
        <section className="breedContentMow">
...
export function MissMe() {
    return (
        <section className="horseContentMow">
            ...
            <br />
            <img src={missmePed} alt="Miss Me Pedigree" width="350"></img>
        </section>
    );
}
...
export function Nova() {
    return (
        <section className="horseContentMow">
            ...
            <br />
            <img src={novaPed} alt="Nova Pedigree" width="350"></img>
        </section>
    );
}
...
export function Bree() {
    return (
        <section className="horseContentMow">
            ...
            <br />
            <img src={breePed} alt="Bree Pedigree" width="350"></img>
        </section>
    );
}
...
export function Effie() {
    return (
        <section className="horseContentMow">
            ...
            <br />
            <img src={effiePed} alt="Effie Pedigree" width="350"></img>
        </section>
    );
}
...
export function Maestro() {
    return (
        <section className="horseContentMow">
            ...
            <br />
            <img src={maestroPed} alt="Maestro Pedigree" width="350"></img>
        </section>
    );
}
...
export function Valkyrie() {
    return (
        <section className="horseContentMow">
            ...
            <p>Photos by: Ashlei Boucher </p>
            <br />
            <img src={valkyriePed} alt="Valkyrie Pedigree" width="350"></img>
        </section>
    );
}
...
export function Tumblena() {
    return (
        <section className="horseContentMow">
            ...
            <p>Photos by: Mark J. Barrett and Jamie Mammano</p>
            <br />
            <img src={tumblenaPed} alt="Tumblena Pedigree" width="350"></img>
        </section>
    );
}
export function Max() {
    return (
        <section className="horseContentMow">
            ...
            <br />
            <img src={maxPed} alt="Max Pedigree" width="350"></img>
        </section>
    );
}
export function Contact() {
    return (
        <div  className="homeContentMow">
